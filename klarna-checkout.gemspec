...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A Ruby wrapper for the Klarna Checkout API.}
  spec.description   = %q{The gem provides methods to fetch, create, capture, cancel and refund Klarna orders.}
